...
<div id="main">
      ...
      <h3 align="left">These are the list of policies to be Dispached</h3>
...
?> 
       <table width="828" border="1" cellpadding="5" cellspacing="0">
          ...
          echo "<tr>";
            echo "<td>".$count++."</td>";
            echo "<td><a href=\"update_policy.php?policyno=".$row['policy_no']."\"target=\"_blank\">".$row['policy_no']."</td>";
            echo "<td>".$row['name']."</td>";
            echo "<td>".$row['type']."</td>";
            echo "<td></td>";
          echo "</tr>";
