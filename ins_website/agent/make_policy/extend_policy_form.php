...
<title>Form Extend Policy</title>
...
if(mysql_num_rows($result_set) >= 1)
{
	...
	?>
<form id="form1" name="form1" method="post" action="extend_policy.php<?php echo "?polino=".$row['policy_no']; ?>">
  <table width="635" border="0" cellpadding="10" cellspacing="0">
    ...
    <tr>
      <th scope="row">New Premium</th>
      <td><label for="textfield"></label>
      <input type="text" name="premium" id="textfield" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <th scope="row">New Renewal Date</th>
