...
include_once("includes/form_functions.php");
	// START FORM PROCESSING
		...
		if ( empty($errors) ) {
			...
			echo "  ".$policy_no;	
			$l_typ="SELECT house_no FROM  house WHERE policy_no='$policy_no'";
			$l_result = mysql_query($l_typ, $connection);
			$l_fetch=mysql_fetch_array($l_result);
			echo "           ".$l_fetch['house_no'];
			$hno=$l_fetch['house_no'];
			$query = "INSERT INTO house_claim  
									( house_no  , fir_no ,  description  , expense , claim_no  ) 
									VALUES ('{$hno}', '{$fir_no}' , '{$description}', {$expense} , {$claim_no})";
...
<div id="main">
      ...
      <p align="left">&nbsp;</p>
      <h3 align="left" style="position:relative;left:+106px">Please Enter The Incident Details:</h3>
      
      <p align="left"><?php if(isset($message))echo $message; ?>&nbsp;</p>
   
          
		
			<form id="form2" name="form2" method="post" action=<?php echo "house_claim.php?policy_no=".$policy_no;?> >
			<table width="731" border="0" cellspacing="10">
			    ...
			    <tr>
			      <th scope="row">&nbsp;</th>
			      <th scope="row"><div align="left">Incident Date</div></th>
